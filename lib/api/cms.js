...
export default class CMS {
   ...
   static getSellers() {
        return axios
            .get('https://api.fundi.vn/api/v1/cashback/list')
            .then(function(res) {
                return res;
            })
            .catch(function(e) {
    ...
    static getCategories() {
     ...
     static getOrderList(page,status) {
        return axios
            .get('https://api.fundi.vn/api/v1/my-account/orders/get?page_size=20&page='+page+'&status='+status)
            .then(function(res) {
                return res;
            })
            .catch(function(e) {
     ...
     static updateUserDetail(data) {
        return axios
            .post('https://api.fundi.vn/api/v1/my-account/detail',data)
            .then(function(res) {
                return res;
            })
            .catch(function(e) {
     ...
     static getBankList() {
        return axios
            .get('https://api.fundi.vn/api/v1/bank/list?per_page=100')
            .then(function(res) {
                return res;
            })
            .catch(function(e) {
