...
class PageCategory extends Component {
    ...
    static async getInitialProps({query}){
      ...
      let category = json.data.filter(item => {
        return item.slug == query.cat_name;
      });
    
      return {
          categories : json.data,
          toal : res.data.pagination.total,
          products : res.data.data,
          catName: category[0] && category[0].title,
          searchName : query.q ? query.q : '',
          catUrl : query.cat_name
      }
    }
